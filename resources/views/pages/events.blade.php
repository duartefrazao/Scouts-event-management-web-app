...
<div id="home-container" class="container-fluid col-xs-12">
  <nav>
    <div class="nav nav-tabs " id="nav-tab" role="tablist">
      <a class="nav-item nav-link active" id="nav-event-tab" href="#nav-events" role="tab" aria-controls="nav-events"
        aria-selected="true"> <i class="fas fa-calendar-check"></i> Events</a>
      <a class="nav-item nav-link" id="nav-groups-tab" href="#nav-groups" role="tab" aria-controls="nav-groups"
        aria-selected="false"> <i class="fas fa-users"></i> Groups</a>
    </div>
  </nav>

  <div class="tab-content" id="nav-tabContent">
    <div class="tab-pane fade show active" id="nav-events" role="tabpanel" aria-labelledby="nav-event-tab">
